...
Qualification-v1 is also a separate branch evidence path. PR #331 merged only into `testing/qualification-v1`, moving open PR #152 to exact branch head `24816ebc778b26497dd30497e59f6f2badcf39ed`. Named technical qualification lanes on that head are positive, but protected maintainer approval remains **FAIL** and security review is incomplete; none of that branch evidence becomes accepted current-main capability.
...
5. Complete #152 exact-head governance/security review before treating Qualification-v1 as accepted; branch PASS is not current-main qualification.
