...
EXPECTED_FACTORY_TRUST_SURFACE = frozenset({
...
class OwnershipGateTests(unittest.TestCase):
    ...
    def test_protected_set_matches_reviewed_current_factory_surface(self):
        self.assertEqual(gate.PROTECTED_FILES, EXPECTED_FACTORY_TRUST_SURFACE)
        self.assertEqual(len(gate.PROTECTED_FILES), 12)
