...
1. **Close the independent-review governance gap.** Issue #144 remains open. Retain a genuinely independent post-merge technical review of the #156 merged surface. PR #146 is refreshed onto current main at `c416d408149408ff8668a48d6e73eb1f3bf6347e`; its six observed ordinary workflows are **PASS** and its policy regression suite passes **15/15**, while the live `independent-review` gate correctly reports **BLOCKED** and exits nonzero because no qualifying independent human approval is bound to that exact head. Obtain that approval before integration. After integration, the active ruleset still needs a maintainer change so approving review count is at least one and the new status is required.
...
3. **Obtain independent acceptance for technically qualified WebVM repair #153.** It consolidates the closed-unmerged #140/#150 repairs and is based on exact current main at `35cbf2ba060bc04aabb6cfd10fbf90dc8dbccb77`. All eight observed applicable exact-head workflows are **PASS**, including Browser VM Demo CI and Pages/WebVM. The submitted owner COMMENT is not current-head independent acceptance. Require a genuinely independent exact-head approval before integration, then refresh/requalify #89; its retained historical Pages failure remains authoritative.
...
8. **Independently review refreshed integration candidates.** #118 `ee81051220c616f8a605c948820d972177e19801`, #115 `27e6e3b790d950ad1e8dd3603569f2eb5090ada4`, and #131 `0094dd4c27231f8c4f71161b9a82770a27c7aa7b` are now current-main and fully green on their applicable exact-head workflows, but each has zero reviews. #115 remains procedure/simulation evidence rather than elapsed soak; #131 stays separate. #93 remains red because of its retained runtime-journal concurrency failure and protected dependency.
