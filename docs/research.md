...
All seven ordinary first-attempt `push` workflows on exact current main completed **PASS**, including Pages/deployment run `35288585007` on attempt 1. These are integration/qualification observations, not scientific outcome evidence.
