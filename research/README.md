...
- `M6-WB-001` — **runnable**. One first-authoritative Workbench end-to-end governance pilot using an onboarded local Ollama model. The candidate is declarative JSON; no model-authored code is executed.
