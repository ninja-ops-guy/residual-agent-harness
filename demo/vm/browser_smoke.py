...
async def main() -> int:
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            await command_proof('python3 -c "from residual.workbench.webvm_wait import wait; [wait(0.001) for _ in range(400)]; print(\'WEBVM_WAIT_PASS\',400)"')
            await stage("webvm_libc_wait_400_calls_passed")
