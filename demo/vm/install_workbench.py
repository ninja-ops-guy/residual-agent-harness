...
def install(source: Path, site: Path):
    ...
    for name in ('mission-control.js', 'mission-control-engineer.js', 'mission-control-world.js', 'mission-control-diagnostics.js', 'mission-control-timetravel.js', 'mission-preview.js', 'provider-session.js'):
