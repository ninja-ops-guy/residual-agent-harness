...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as root:
        root=Path(root)
        src=root/"repo"
        ws.init_repo(src,{"README.md":"# M6-SPEC-007Q branch-aware review fixture\n"})
        ...
        manifest={"name":"M6-SPEC-007Q Branch-Aware Review","goal":"Originate and admit one evidence-grounded improvement proposal.","tasks":[{
        ...
        print("M6_SPEC_007Q_EVIDENCE="+json.dumps(evidence,sort_keys=True,separators=(",",":")))
