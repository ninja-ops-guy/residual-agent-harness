...
def main() -> int:
    ...
    ap.add_argument("--output",default="runs/m6-spec-007g/evidence.json")
    a=ap.parse_args()
    ...
    with tempfile.TemporaryDirectory() as root:
        ...
        verifier_revision=digest({"experiment":"M6-SPEC-007G","rules":"typed-admission-v1"})
        receipt=None
        if admitted:
        ...
        print("M6_SPEC_007G_EVIDENCE="+json.dumps(evidence,sort_keys=True,separators=(",",":")))
