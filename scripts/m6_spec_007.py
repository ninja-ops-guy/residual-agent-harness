...
def main() -> int:
    ...
    p.add_argument("--output", default="runs/m6-spec-007/evidence.json")
    args = p.parse_args()
    ...
    payload = {
        ...
        "scope": "M6 model-driven self-development and roadmap-shipping runs with recorded provider usage",
    }
