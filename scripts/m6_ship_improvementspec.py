...
def main() -> int:
    ...
    p.add_argument("--output", default="runs/m6-roadmap-ship-004/improvementspec-evidence.json")
    a=p.parse_args()
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        manifest={
            ...
            "tasks":[{
                ...
                "context":["scripts/m6_ship_improvementspec_check.py"],
                "depends_on":[],
                "route":"local",
                "checks":[
